...
const ByndrRoutes = [
    ...
    {
        pageName: "Blog child2",
        title: "Blog child2",
        seoVisibility: true,
        metaTitle: "Blog Child2",
        metaTags: "Blog Meta Tags child2",
        path: '/blog/key-factors-to-consider-when-planning-to-collaborate-with-a-mobile-lms-platform',
        metaDescription:"BlogChild2",
        component: BlogChild2,
    },{
        pageName: "Blog child3",
        title: "Blog child3",
        seoVisibility: true,
        metaTitle: "Blog Child3",
        metaTags: "Blog Meta Tags child3",
        path: '/blog/use-of-learning-management-systems-in-indi',
        metaDescription:"BlogChild3",
